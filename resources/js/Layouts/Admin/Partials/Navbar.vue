<script setup>
  ...
  import NavLink from '@/Layouts/Admin/Partials/NavLink.vue';
  import ResponsiveNavLink from '@/Layouts/Admin/Partials/ResponsiveNavLink.vue';
      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          ...
          <div class="flex shrink-0 items-center">
            <Link :z-route="{ name: 'home' }">
              <AppLogo class="block h-9 w-auto" variant="icon" />
            </Link>
          </div>
